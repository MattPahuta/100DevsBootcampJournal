...
**Today's Progress**: Per usual, started off with FCC and Code Wars challenges before moving on to work further on the Frontend Mentor project. Then, finished review of class 27, working mostly with APIs.

### August 30, Tuesday

**Today's Progress**: Free Code Camp and Code Wars early, more work on the FEM project, and more review of class 27.
...
**Today's Progress**: Free code camp kicked off the day, then moved on to some Code Wars challenges before finishing up with more work on the Front End Mentor project.
...
**Today's Progress**: FCC JavaScript work to start my morning, followed by more Frontend Mentor project work and then catching up on 100Devs class 26. Also mixed in some Code Wars challenges and a bit of Anki review.


### August 20, Saturday

**Today's Progress**: Started again with FCC JavaScript fundamental reviews and challenges before moving on to continue work on a Frontend Mentor project.
